...
I am a post-doctoral fellow with the Science and Mathematics Program Improvement unit which is associated with the Mallinson Institute of Science Education at Western Michigan University. 
I am also a recent graduate of the Mallinson Institute, and I am currently preparing several manuscripts for publication from my dissertation and associated work.
...
tribble(
  ...
  "", "", 
  list(
    "Explaining Heterogeneity in Science Education Research: Comparing machine learning model with \\textit{a priori} meta-regression models (Dissertation Paper)",
    "Challenges and Solutions for Knowledge Accumulation in Science Education Research (Dissertation Paper)",
    "Mapping the Homeschooling Literature: A Scoping Review and Source Analysis",
    "Impact of Different Literature Search Approaches on Informal Literature Reviews: Recommendations for consumers of education research"
  ),
...
tribble(
  ...
  ## PhD
  "Ph.D. in Science Eduation: Biological Sciences", "Western Michigan University", 
  "Kalamazoo, Michigan", "2017-2024",
    list("Dissertation: Beyond Average Effects in Education Research: \\textit{Explaining heterogeneity of concept mapping research in science education through meta-regression modeling}. A three-paper dissertation composed of two independent systematic reviews and meta-analyses - third paper is a position paper arguing for the particular uses of meta-analytic methods exemplified by my work",
         "Comittee chaired by Dr. William Cobern, with Dr. Betty Adams and Dr. Ya Zhang",
         "Concurrently enrolled in M.A. Biology program until spring 2021"),
  ## Masters
  ...
  "Grand Rapids, Michigan", "2011-2015",
    list("Senior Thesis Project: a meta-study of the neural crest as a mechanism for vertebrate phenotypic diversity",
...
tribble(
  ...
  "Science And Mathematics Program Improvement", "Kalamazoo, Michigan",
  list(
    "Conducting evaluation work for MiSTEM Michigan Department of Education project",
  ...
  "Certified under v5.0 group design standards",
) %>%
  arrange(desc(when)) %>%
